...
export default function IndividualCharacter(props) {
  const [characterImage, setCharacterImage] = useState(<img src={require(`./characters/${props.id.toString()}.png`)} className="characterImage" alt="" style={{ width: "65px", height: "65px" }} />)
